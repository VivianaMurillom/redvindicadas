...
function Submenuj(){
    return(
        <div class="contents-buttons">
            <Link to='/redvindicadas/juegayaprende/recursos-j1' className='item-sub'>
                <div class="cambios"> 
                    <img src={cambios} alt="Imagen 1"/>
                    <p>Cambios</p>
                </div>
            </Link>
            <Link to='/redvindicadas/juegayaprende/recursos-j2' className='item-sub'>
                <div class="EIS">
                    <img src={eis} alt="Imagen 2"/>
                    <p>EIS</p>
                </div>
            </Link>
            <Link to='/redvindicadas/juegayaprende/recursos-j3' className='item-sub'>
