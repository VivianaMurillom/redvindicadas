    ...
    <article className="contenedor-menu-jovenes">
        <div className="con-recursos">
            ...
            <div className="enlace">
                <Link to='/redvindicadas/juegayaprende/jovenes-recursos1' className='active'>Recursos</Link>
            </div>
        </div>
        ...
        <div className="con-juegos">
            ...
            <div className="enlace">
                <Link to='/redvindicadas/juegayaprende/jovenes-juegos' className='active'>Juegos</Link>
            </div>
        </div>
    </article>
    );
