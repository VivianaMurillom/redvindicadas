    ...
    <article className="contenedor-menu-jovenes">
        <div className="con-recursos">
            ...
            <div className="enlace">
                <Link to='/redvindicadas/juegayaprende/recursos-j1' className='active'>Recursos</Link>
            </div>
        </div>
        ...
        <div className="con-juegos">
            ...
            <div className="enlace">
                <Link to='/redvindicadas/juegayaprende/juegos-j' className='active'>Juegos</Link>
            </div>
        </div>
    </article>
    );
